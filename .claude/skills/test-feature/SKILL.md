---
name: test-feature
description: Writes specification-driven tests and executes them for a specific Spendly feature. Uses the feature spec to generate comprehensive pytest tests, then runs only that feature's test file and reports whether the implementation satisfies the specification. Use this whenever the user asks to test, validate, verify, or check a Spendly feature against its spec, or requests commands like "/test-feature <spec-name>".
allowed-tools: Bash(python -m pytest)
disable-model-invocation: true
---

# Spendly Feature Testing Pipeline
