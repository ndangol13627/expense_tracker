...
- **Modify**: `templates/profile.html`
  - Amounts must be rendered with the $ symbol (USD).
...
- No inline styles
- Currency must always display as $ (USD) — never £ or ₹
...
- `total_spent` matches sum of all seed expenses (388.25)
...
- [ ] Total spent displayed on the profile page equals $388.25
